...
public class AboutDateTimeAPI {
	...
	public void java8_datesAreImmutable() {
		...
		LocalDateTime date2 = date.plusHours(durationtoAdd.toHours()); // FIXME: See if you can find a way to add the durationToAdd to the date
	...
	public void java8_durationsCanAlsoBeUsedToCreateDate() {
		...
		LocalDateTime future = now.plusDays(duration.toDays()); // FIXME: add the duration to now 
